...
`querylab` is centered on databases work in SQL. The technical target is: Package relational fixtures and sqlite3 checks for query correctness.
...
The score is deterministic. The current threshold is 182. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 6.
