"""Regression checks for the querylab casebook."""
...
from casebook.harness import assert_expected, querylab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(querylab_summary(), assert_expected())
